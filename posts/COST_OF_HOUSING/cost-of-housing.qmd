...
This period saw significant growth over a brief period of time. From June 1948 to December 1964, real median household income grew from `r dollar(p1_ri_1)` to `r dollar(p1_ri_2)` representing an annual growth of `r round((((p1_ri_2/p1_ri_1) - 1)/getDif(as.Date("1948-06-01"), as.Date("1964-12-01")) * 100), 2)` pp per year. NEED DETAILS ON ECONOMIC CONDITION.
